...
namespace FMODUnity
{
    public class FileReorganizer : EditorWindow, ISerializationCallbackReceiver
    {
        ...
        private struct TaskGenerator
        {
            ...
            private const string FMODRoot = "Packages/com.firelight.fmod-for-unity/FMOD";
            ...
            private static readonly string[] fmodFoldersToCleanUp = {
                "Packages/com.firelight.fmod-for-unity/FMOD/Runtime",
                "Packages/com.firelight.fmod-for-unity/FMOD/lib",
            };
